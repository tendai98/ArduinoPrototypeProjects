...
void ADD(){ cpu.R[cdx->v1] += cpu.R[cdx->v2]; }
void SUB(){ cpu.R[cdx->v1] -= cpu.R[cdx->v2]; }
void MUL(){ cpu.R[cdx->v1] *= cpu.R[cdx->v2]; }
void DIV(){ cpu.R[cdx->v1] /= cpu.R[cdx->v2]; }
void MOD(){ cpu.R[cdx->v1] %= cpu.R[cdx->v2]; }
void AND(){ cpu.R[cdx->v1] &= cpu.R[cdx->v2]; }
void LOR(){ cpu.R[cdx->v1] |= cpu.R[cdx->v2]; }
void XOR(){ cpu.R[cdx->v1] ^= cpu.R[cdx->v2]; }
void NOT(){ cpu.R[cdx->v1] = !cpu.R[cdx->v2]; }
void CRR(){ cpu.R[cdx->v1] = cpu.R[cdx->v2];  }
void CDR(){ cpu.R[cdx->v1] = cdx->v2; }
